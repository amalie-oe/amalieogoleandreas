  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="#D8D8D6" stopOpacity="0.85" />
          <stop offset="0.5" stopColor="#D8D8D6" stopOpacity="0.35" />
          <stop offset="1" stopColor="#D8D8D6" stopOpacity="0" />
        </radialGradient>
        <radialGradient
          id="floodGrad"
@@ -47,8 +47,8 @@
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#D8D8D6" stopOpacity="1" />
          <stop offset="1" stopColor="#D8D8D6" stopOpacity="0" />
        </radialGradient>
...
@@ -60,46 +60,46 @@
      ...
      {/* Grunn / skjær */}
      <ellipse cx="600" cy="450.8" rx="70" ry="21" fill="#ADA69B" />
      <ellipse cx="552.2" cy="469.8" rx="52" ry="23.8" fill="#67717E" />
      <ellipse cx="663.4" cy="464.8" rx="29.2" ry="16.8" fill="#67717E" />
      ...
      <polygon
        ...
        fill="#67717E"
      />
      <rect x="591.6" y="403.2" width="16.8" height="33.6" rx="8" fill="#45505F" />

      {/* Galleri */}
      <rect x="563.6" y="229.6" width="72.8" height="12.6" rx="3" fill="#45505F" />

      {/* Lanterne-rom */}
      <rect x="577.6" y="190.4" width="44.8" height="39.2" fill="#45505F" />
      <circle cx="600" cy="210" r="10" fill="#F2EFE8" />
      <circle cx="600" cy="210" r="30" fill="url(#glow)" className="animate-glow" />

      {/* Tak */}
      <polygon points="572,190 600,154 628,190" fill="#67717E" />
      <circle cx="600" cy="151" r="6" fill="#ADA69B" />
