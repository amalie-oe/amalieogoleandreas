...
export default function Lighthouse() {
  ...
  return (
    ...
    >
      ...
      <ellipse cx="552.2" cy="469.8" rx="52" ry="23.8" fill="#98B4C7" />
      <ellipse cx="663.4" cy="464.8" rx="29.2" ry="16.8" fill="#98B4C7" />
      ...
      {/* Galleri */}
      <rect x="563.6" y="229.6" width="72.8" height="12.6" rx="3" fill="#3D5A80" />
      ...
      {/* Tak */}
      <polygon points="572,190 600,154 628,190" fill="#98B4C7" />
      <circle cx="600" cy="151" r="6" fill="#98B4C7" />
